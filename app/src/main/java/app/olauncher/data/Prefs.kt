...
class Prefs(context: Context) {
    ...
    private val LAST_APP_DRAWER_SHUFFLE_DATE = "LAST_APP_DRAWER_SHUFFLE_DATE"
    ...
    var lastAppDrawerShuffleDate: String
        get() = prefs.getString(LAST_APP_DRAWER_SHUFFLE_DATE, "").toString()
        set(value) = prefs.edit { putString(LAST_APP_DRAWER_SHUFFLE_DATE, value).apply() }
